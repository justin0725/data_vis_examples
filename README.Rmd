...
```{r linkedin info, include=FALSE}

# Use the below link for directions to feature this on linkedin
...
```{r funding flows, out.width = "700px"}
knitr::include_graphics(here::here("img", "nc_funding.png"))
```
<br/>
<br/>
<br/>
...
<br/>
```{r Lopez de Leon RDD plot, message=FALSE, warning=FALSE, out.width = "900px"}
knitr::include_graphics(here::here("img", "RDD_plot.png"))
```
<br/>
...
<br/>
```{r Lopez de Leon barchart, out.width = "900px"}
knitr::include_graphics(here::here("img", "balance_VOTE.png"))
```
<br/>
...
<br/>
```{r DiD table, out.width = "900px"}
knitr::include_graphics(here::here("img", "pope_table2.jpg"))
```
<br/>
<br/>
<br/>
...
<br/>
```{r Garfinkel table}
knitr::include_graphics(here::here("img", "garf_national.png"))
```
<br/>
<br/>
<br/>
...
<br/>
```{r fletcher scatterplot 1, out.width = "600px"}
knitr::include_graphics(here::here("img", "income.png"))
```
<br/>
<br/>
```{r fletcher scatterplot 2, out.width = "600px"}
knitr::include_graphics(here::here("img", "race.png"))
```
<br/>
<br/>
<br/>
...
<br/>
```{r Pierson traffic stops, out.width = "900px"}
knitr::include_graphics(here::here("img", "pierson_plot1.png"))
```
<br/>
<br/>
<br/>
...
```{r dogs, out.width = "900px"}
knitr::include_graphics(here::here("img", "dogs.png"))
```
